    ...
    <div class="col-md-4 col-md-offset-4">
      <form class="form-horizontal" role="form">
        <fieldset>
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="textinput">Endere�o: </label>
            <div class="col-sm-10">
              <input type="text" placeholder="Endere�o" class="form-control">
            </div>
          </div>

		  <div class="form-group">
            <label class="col-sm-2 control-label" for="textinput">N�mero:</label>
            <div class="col-sm-2">
